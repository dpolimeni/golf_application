"""
Django settings for MyGolfapp project.
...
SECRET_KEY = 'django-insecure-0lny*!2tx6wepd2rcf+^y12+t)-fa)jt@##n7acu))rtu*crj!'
...
WSGI_APPLICATION = 'MyGolfapp.wsgi.application'
...
## Crispy forms
CRISPY_TEMPLATE_PACK = "bootstrap5" ## set the crisy form bootstrap version

## MEDIA management
MEDIA_ROOT = os.path.join(BASE_DIR, "media")  ### path to directory where django is going to store uploaded files (on file system not on DB)
